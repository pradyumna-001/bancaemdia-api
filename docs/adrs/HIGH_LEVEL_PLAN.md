...
> **Revisão de orçamento necessária (22/09/2026):** esta estimativa histórica descreve uma configuração menor que a exigida pela issue #41 e implementada no Terraform. Ela não é uma previsão de custo do Terraform atual. As metas informadas são cerca de R$ 100/mês no começo, R$ 200/mês para os primeiros 100 usuários e US$ 300/mês com 1.000 usuários; veja a [comparação de custos e o pedido aberto ao administrador](../decisions/aws-initial-budget.md) antes de provisionar.
