...
class Aposta(Base):
    ...
    tipster_id: Mapped[int | None] = mapped_column(BigInteger)
    time_casa_id: Mapped[int | None] = mapped_column(BigInteger)
    time_fora_id: Mapped[int | None] = mapped_column(BigInteger)
    mercado_id: Mapped[int | None] = mapped_column(BigInteger)
    competicao_id: Mapped[int | None] = mapped_column(BigInteger)
